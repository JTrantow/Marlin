...
#define STRING_CONFIG_H_AUTHOR "(JJT, CoreXY)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "JJT CoreXY"
 ...
 */
  ...
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 640, 409 }
#else
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 640, 108.75, 818/2 }
#endif
/**
...
//#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  * Override with M203 (G12 from G28 home seems to be limiting movement.)
  *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
  */
  #define DEFAULT_MAX_FEEDRATE          { 1200, 1200, 500, 2000 }
  ...
  */
  ...
  #endif
#else
  #define DEFAULT_MAX_FEEDRATE          { 2000, 2000, 500, 2000, 1000 }
  #define DEFAULT_MAX_ACCELERATION      { 2000, 1000, 500, 1000, 10000 }
#endif
...
#define Z_MAX_POS 545         // Must be accurate within Z_PROBE_ERROR_TOLERANCE for probing to work.
//#define I_MIN_POS 0
...
#if defined(I_DRIVER_TYPE)
  #define HOMING_FEEDRATE_MM_M { (100*60), (100*60), 1000, (25*60) }
#else
  #define HOMING_FEEDRATE_MM_M { 20000, 20000, 1800 }
#endif
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define CLEAN_STRIP_X_DIM ( 8)
  #define CLEAN_STRIP_Y_DIM (36)

  #define NOZZLE_CLEAN_START_POINT { {  X_MAX_POS-CLEAN_STRIP_X_DIM, Y_MIN_POS, 40 } }
  #define NOZZLE_CLEAN_END_POINT   { {  X_MAX_POS, Y_MIN_POS+CLEAN_STRIP_Y_DIM, 40 } }
